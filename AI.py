...
class AI:
    ...
    def get_init_ants_next_move(self, preferred_moves) -> int:
        ...
        print_with_debug("error on get_init_ants_next_move")
    ...
    def get_init_ant_explore_move(self):
        ...
        if m < 5:
            ...
            print_with_debug("something went wrong, init ants move :", m, "from id:", AI.id)
            return Direction.get_random_direction()
    ...
    def get_init_ant_collect_move(self):
        ...
        if self.game.ant.currentResource.type == ResourceType.BREAD:
            ...
            grass_dir, AI.last_name_of_object, grass_dis = own_map.get_resource_best_move(
                src_pos=self.pos,
                dest_pos=AI.map.base_pos,
                name_of_object='grass',
                limit=get_limit(
            ...
            bread_dir, AI.last_name_of_object, bread_dis = own_map.get_resource_best_move(
                src_pos=self.pos,
                dest_pos=AI.map.base_pos,
                name_of_object='bread',
                limit=get_limit(
        ...
        if AI.game_round == 1:
            ...
            if self.game.ant.currentResource.value == WORKER_MAX_CARRYING_RESOURCE_AMOUNT:
                ...
                if AI.id <= Utils.INIT_ANTS_NUM:
                    ...
                    # else:
                    if self.has_resource_in_own_map(2, 10) is None:
                        self.direction = self.get_init_ant_explore_move()
                    ...
                    if self.direction == 0 or self.direction is None:
                        print_with_debug("new ants at the end:", self.direction)
                        print_with_debug("=> move like init ant explore")
                        self.direction = self.get_init_ant_explore_move()
    ...
    def worker_explore(self):
        ...
        # print_with_debug("scores, right up left down", scores)
    ...
    def calculate_score(self, size):
        ...
        for i, dd in enumerate(d):
            ...
            if AI.map.nodes[pos].discovered and AI.map.nodes[pos].wall:
                ...
                print_with_debug("HUGE MOTHERFUCKING ERROR!")
    ...
    #             print_with_debug("left-up region : ", m)
    #         else:
    #             # left-down region
    ...
    #             print_with_debug("left-down region : ", m)
    #     else:
    #         if self.game.baseY < (self.game.mapHeight / 2):
    #             # right-up region
    ...
    #             print_with_debug("right-up region : ", m)
    #         else:
    #             # right-down region
    ...
    #             print_with_debug("right-down region : ", m)
    #     if m < 5:
    #         return m
    #     else:
    #         print_with_debug("something went wrong, init ants move :", m, "from id:", AI.id)
