...
class AI:
    ...
    def turn(self) -> (str, int, int):
        ...
        if AI.life_cycle > 1 and (not self.shot or self.value == VALUES["enemy_base"]):
        ...
        elif AI.life_cycle > 1 and self.shot and self.game.ant.antType == AntType.SARBAAZ.value and (AI.soldier_state == SoldierState.Null or AI.soldier_state == SoldierState.CellTargetFound):
            ...
            print_with_debug("tell them", AI.latest_pos[AI.id][0], possible_cells, AI.own_cells_history[-3], f=AI.out_file)
